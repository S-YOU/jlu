...
$(function () {
    ...
    var start = function () {
        //add menu
        if (!$("#upopup").length)
            $("#footer-menu").prepend('<a onclick="$(\'#upopup\').toggle()">options</a><div id="upopup" style="color:black;position:absolute;display:none;background-color:#fff;border:1px solid #ccc;margin-top:3px;padding:5px;z-index:500;box-shadow:1px 1px 2px rgba(0,0,0,0.2);"/> |');
        //add options box
        $("#upopup").append(
      '<div><h4>ruby mode</h4>' +
      ...
      '</div>'
       ).find("div").css({ 'color': '#000' }).find("a,input").css({ 'color': '#00f', 'text-shadow': 'none', 'vertical-align': 'middle', 'font-weight': 'normal' });
        //load settings
      ...
      'rt{display:table-header-group;font-size:0.75em;line-height:1.1;text-align:center;white-space:nowrap;border:none;margin:0;padding:0;}';
        ...
        var replaces = [
      /(?:&#91;|\[)([^\]]+)\]\{([^}]+)\}/g,
      /(?:&#91;|\[)([^\]]+)\]\{([^}]+)\}|([\u4e00-\ufeed]+)\s*[{\u3010]([.\u3001\u3002\u3041-\u30fe\uff0d-\uff0f\uff61]+)[}\u3011]|([\u3041-\u30fe]+)\s*[{\u3010]([a-zA-Z\u0101-\u014d' ]+)[}\u3011]/g,
      /(?:&#91;|\[)([^\]]+)\]\{([^}]+)\}|(?:&#91;|&quot;|&ldquo;|["\u201c\[])?([\u4e00-\ufeed]+)(?:&#91;|&quot;|&rdquo;|["\u201d\]])?\s*[\[{(\uff08\uff5b\u3008-\u301a]([.\u3001\u3002\u3041-\u30fe\uff0d-\uff0f\uff61]+)[\]})\uff09\uff5c\uff5d\u3009-\u301b]|(?:&#91;|&quot;|&ldquo;|["\u201c\[])?([\u3041-\u30fe]+)(?:&#91;|&quot;|&rdquo;|["\u201d\]])?\s*[\[{(\uff08\uff5b\u3008-\u301a]([a-zA-Z\u0101-\u014d' ]+)[\]})\uff09\uff5c\uff5d\u3009-\u301b]/g
